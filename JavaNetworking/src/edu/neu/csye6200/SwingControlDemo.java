...
import edu.neu.csye6200.util.TextAreaUpdaterTask;
...
//				m_task.start();
	...
	public StringBuffer useCommand(String cmd) {
		System.out.println(SwingControlDemo.class.getSimpleName() + ".useCommand('" + cmd + "')");
...
//		obj.useCommand("java");
//		System.out.println("\n\t Execute ./Cmd1b/Cmd1.class:");
//		obj.useCommand("java -cp Cmd1b Cmd1");
//		obj.useCommand("java -cp Cmd1b Cmd1 argument1");
//		System.out.println("\n\t Execute ./Cmd1b/Cmd1.jar:");
//		obj.useCommand("java -jar Cmd1b/Cmd1.jar");
//		obj.useCommand("java -jar Cmd1b/Cmd1.jar arg1");
